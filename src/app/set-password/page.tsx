  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message?.includes('403') || err.message?.toLowerCase().includes('expired') || err.message?.toLowerCase().includes('invalid')) {
        setError('This link has expired or is invalid. Please request a new password setup link.');
      } else {
          ...
          {isSuccess ? (
            <>
              <CardHeader className="space-y-1 text-center">
                ...
                <CardDescription className="text-base">
                  Your account is now active. You can sign in with your username and new password.
                </CardDescription>
              </CardHeader>
              <CardFooter>
            ...
            <>
              <CardHeader className="space-y-1">
                ...
                <CardTitle className="text-2xl text-center">Welcome! Set your password</CardTitle>
                <CardDescription className="text-center">
                  Create a secure password for your account. Minimum {passwordMinLength} characters.
                </CardDescription>
              </CardHeader>
